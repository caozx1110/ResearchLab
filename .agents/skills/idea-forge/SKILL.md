...
- Treat `kb/memory/domain-profile.yaml` as the source of workspace-local query heuristics and repo-role vocabulary; proposal templates should stay field-agnostic.
