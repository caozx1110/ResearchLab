...
1. Read `AGENTS.md` plus `doc/research/memory/user-profile.yaml` first.
...
4. Refresh:
   ...
   - `doc/research/user/reading-lists/<program-id>-current-reading.md`
   - `doc/research/user/reports/current-deliverables.md`
...
- Keep durable user-facing navigation inside `doc/research/user/`, not in chat only.
- Preserve stable relative links so the pages work in VSCode and Obsidian.
- Treat `doc/research/user/kb/` as generated read-only browser output; do not edit it manually here.
