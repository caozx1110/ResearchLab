...
Load only this reference while preparing, appending, resuming, or closing a search stage. Candidate materialization uses the separate selection contract linked directly from `SKILL.md`.

## 目录

- [Stage payload](#literature-search-stage-payload)
- [Reviewer and systematic-mode rules](#reviewer-and-systematic-mode-rules)
...
## Reviewer and systematic-mode rules
