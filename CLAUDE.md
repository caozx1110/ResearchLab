...
# CLAUDE.md — 开发本 skill 系统的工作流

> 本文件面向**在本仓库开发/演进 skill 系统的 Claude 会话**（不是使用 kb 的 end user——那套规则在 `AGENTS.md`）。
...
| `AGENTS.md` | 工作区运行规则、写作偏好、路由、入库自动驱动 | SSOT 下挂；面向用 kb 的 agent |
